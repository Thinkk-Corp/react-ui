...
export const Navbar = () => {
	...
	return (
		<div
			className={classNames("h-full bg-paper-default flex items-center justify-between px-4 gap-4 lg:px-10", {
				"shadow-md": currentTheme === "light",
				"border-b border-custom-divider": currentTheme === "dark",
			})}
		>
			<IconBox isHoverable onKeyDown={() => {}} onClick={handleMobileMenuTriggerClick} className={"lg:hidden block"}>
			...
			<div className={"flex items-center gap-2 lg:gap-5 border-l border-custom-divider pl-4"}>
				<ThemeChanger />
				<Notifications />
				<UserMenu />
			</div>
